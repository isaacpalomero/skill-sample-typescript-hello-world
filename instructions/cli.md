...
2. **Clone** the repository and navigate into the skill's root directory.
	...
	```bash
	ask new --url https://github.com/isaacpalomero/skill-sample-typescript-hello-world --skill-name hello-world
	cd hello-world
	```

3. Install npm dependencies running the npm command `npm install` inside de project folder.
...
1. Generate "lambda/custom" folder running the npm script `npm run release` inside de project folder.
